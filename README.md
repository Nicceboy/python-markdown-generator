...
Markdown was originally created as a lightweight, user-friendly, user-written text formatting markup language to produce rich text format by using plain text editor, and existence of this kind of library could be against the original purpose of the language.
...
*However*, there are couple of rare use cases, where you might want machine to generate Markdown *instead* of direct HTML.  
  ...
  * Markdown syntax is simple and not fully-featured language, which could result in cleaner and less buggy result. Resulted file itself is a lightweight.
